...
int main(int Arguments, char* Argument[])
{
	...
	int NrOfMoves=0, HorPos=0, VerPos=0, VerAim=0;
	...
	while (fgets(InputLine, 100, InputFile))
	{
		...
		switch (InputMove)
		{
			case eUp:        VerAim -= InputDist;  break;
			case eDown:      VerAim += InputDist;  break;
			case eForward:   HorPos += InputDist;
                       VerPos += InputDist*VerAim; break;
		}
